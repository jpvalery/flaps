...
export interface FlightBookingCancellationEmailProps {
	booking: {
		name: string;
		seats: number;
		flight?: {
...
export default function FlightBookingCancellationEmail({
	booking,
	flightDate,
	flightTime,
}: FlightBookingCancellationEmailProps) {
	return (
		<Html>
			<Head />
			<Body style={main}>
				<Container style={container}>
					<Section style={header}>
						<Heading as="h1" style={headerText}>
							✈️ Flight Booking Cancellation
						</Heading>
					</Section>

					<Section style={content}>
						<Heading as="h2">Hello {booking.name}!</Heading>
						<Text>Sorry that you're not able to make it anymore!</Text>
...
FlightBookingCancellationEmail.PreviewProps = {
	booking: {
		name: 'Jane Doe',
		seats: 2,
		flight: {
