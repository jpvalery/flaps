...
interface FlightBookingReservationEmailProps {
	booking: {
		name: string;
		seats: number;
		flight?: {
...
export default function FlightBookingReservationEmail({
	booking,
	flightDate,
	flightTime,
	confirmationUrl,
}: FlightBookingReservationEmailProps) {
	return (
		<Html>
			<Head />
			<Body style={main}>
				<Container style={container}>
					...
					<Section style={content}>
						...
						<Text>
							Thank you for your flight booking. Please confirm your reservation by
...
FlightBookingReservationEmail.PreviewProps = {
	booking: {
		name: 'Jane Doe',
		seats: 2,
		flight: {
