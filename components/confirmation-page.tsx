...
import { confirmBookingAction, cancelBookingAction } from "@/app/actions/confirmation"
    ...
    return (
      <div className="min-h-screen bg-zinc-950 text-amber-400 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-zinc-300">Unable to load flight details for this booking.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-zinc-950 text-amber-400">
      ...
      <header className="bg-zinc-900 border-b border-amber-600/30 py-6">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold tracking-wider mb-2">BOOKING CONFIRMATION</h1>
            <p className="text-amber-300/80 text-lg tracking-widest">FLIGHT RESERVATION SYSTEM</p>
          </div>
        </div>
      </header>
            ...
            <div className="bg-zinc-800 p-6 border-b border-amber-600/30">
              <div className="flex items-center justify-center space-x-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-zinc-300 mt-1">Booking ID: {booking.id}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-amber-300 mb-4">Passenger Information</h3>
                  <div>
              ...
              {result ? (
                ...
                <div className="mt-8 space-y-4">
                  <div className="bg-amber-600/10 border border-amber-600/30 rounded p-4">
                    <p className="text-amber-300 text-center">
                      ...
                      Please confirm your booking to secure your seats. Your reservation will expire in 24 hours.
                    </p>
                  </div>
                ...
                <div className="mt-8 text-center">
                  <p className="text-zinc-400">
                    {booking.status === "CONFIRMED" && "Your booking has been confirmed. See you at the airport!"}
